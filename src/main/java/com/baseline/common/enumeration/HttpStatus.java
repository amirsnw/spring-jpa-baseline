package com.baseline.common.enumeration;
...
public enum HttpStatus {
    ...
    private static final Map<Integer, HttpStatus> STATUSES = (Map) Arrays.stream(values())
            .collect(Collectors.collectingAndThen(Collectors.toMap(HttpStatus::getStatusCode,
    ...
    public String toString() {
        ...
        return "" + statusCode + " " + this.getReasonPhrase();
    }
}